...
const makeThemeFromSemantic = (semanticColors, isDarkTheme) => {
    ...
    if (isDarkTheme) {
        themeRelatedComputedColors = {
            ...
            'buttons-inactive': (0, colors_transformations_1.lightenColor)(semanticColors.background, 10),
            'main-text-inactive': (0, colors_transformations_1.darkenColor)(semanticColors['secondary-buttons'], 5),
            ...
            'main-text-active': (0, colors_transformations_1.darkenColor)(semanticColors['main-text'], 9),
            'main-text-hover': (0, colors_transformations_1.saturateColor)((0, colors_transformations_1.lightenColor)(semanticColors['secondary-text'], 39), 3),
            'secondary-text-active': semanticColors['secondary-buttons'],
            'secondary-text-hover': (0, colors_transformations_1.darkenColor)(semanticColors['secondary-text'], 11),
            ...
            'input-line-active': (0, colors_transformations_1.lightenColor)((0, colors_transformations_1.desaturateColor)(semanticColors['buttons'], 0.2), 4),
            'input-line-disable': (0, colors_transformations_1.transparizeColor)(semanticColors['secondary-text'], 0.3),
            'input-line-hover': (0, colors_transformations_1.darkenColor)(semanticColors['secondary-text'], 11),
        };
    }
    else {
        themeRelatedComputedColors = {
            ...
            'main-text-inactive': (0, colors_transformations_1.rotateColor)((0, colors_transformations_1.darkenColor)(semanticColors['secondary-buttons'], 15), 20),
            ...
            'input-line-disable': (0, colors_transformations_1.darkenColor)(semanticColors['secondary-buttons'], 10),
